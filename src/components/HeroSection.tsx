...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden py-8 px-4">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className={`space-y-4 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <p className="text-lg md:text-xl lg:text-xl text-white/80 leading-relaxed max-w-4xl">
            ...
            {/* Description */}
            <div className={`text-base md:text-lg lg:text-lg text-white/70 leading-relaxed transition-all duration-1000 delay-700 max-w-4xl ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className={`flex justify-center pt-4 transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`}>
              <button className="group relative overflow-hidden bg-gradient-to-r from-gold-500 to-gold-600 text-black-950 font-bold px-8 py-4 rounded-xl transition-all duration-500 hover:scale-105 hover:shadow-glow-gold-strong hover:from-gold-400 hover:to-gold-500 magnetic">
                {/* Content */}
                <span className="relative z-10 flex items-center justify-center text-lg md:text-xl">
                  PREENCHER APLICAÇÃO
