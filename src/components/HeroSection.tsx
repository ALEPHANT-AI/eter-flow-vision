    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden pt-2 px-4">
      ...
      <div className="absolute inset-0">
        ...
        <img 
          ...
          className="w-full h-full object-cover opacity-30 md:object-center object-[75%_center]" 
        />
        ...
        <div className={`flex justify-start pt-4 transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="text-left">
            <img 
              ...
              alt="ETER"
              className="h-10 md:h-20 object-contain filter brightness-110 contrast-110"
            />
          </div>
        </div>

        {/* Main content centered with better mobile spacing */}
        <div className="flex-1 flex items-center justify-start pt-6 md:pt-24">
          <div className="text-left space-y-2 md:space-y-4 max-w-4xl w-full">
            ...
            <div className={`transition-all duration-1200 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-black mb-1 md:mb-2">
                <span className="text-gradient bg-gradient-to-r from-gold-400 via-gold-500 to-gold-600 bg-clip-text text-transparent">
                  THE EIGHT®
                </span>
              </h1>
              <p className="text-sm md:text-base lg:text-lg text-gold-400/80 font-medium italic mb-3 md:mb-4">
            ...
            <div className={`transition-all duration-1200 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-black leading-tight">
            ...
            <div className={`text-sm sm:text-base md:text-lg lg:text-xl text-white/70 leading-relaxed transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            {/* CTA Button */}
            <div className={`flex justify-start pt-4 md:pt-6 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`}>
              <button 
                onClick={scrollToForm}
                className="group relative overflow-hidden bg-gradient-to-r from-gold-500 to-gold-600 text-black-950 font-bold px-8 md:px-10 lg:px-12 py-3 md:py-4 lg:py-5 rounded-xl transition-all duration-500 hover:scale-105 hover:shadow-glow-gold-strong hover:from-gold-400 hover:to-gold-500 magnetic"
              >
                {/* Content */}
                <span className="relative z-10 flex items-center justify-center text-base md:text-lg lg:text-xl xl:text-2xl">
                  PREENCHER APLICAÇÃO
                  <ArrowRight className="ml-3 md:ml-4 w-5 h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 transition-transform group-hover:translate-x-2" />
                </span>
