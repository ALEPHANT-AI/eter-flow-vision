          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative glass-strong rounded-3xl p-8 overflow-hidden">
                <div className="w-full h-96 lg:h-[500px] bg-gradient-to-br from-gold-500/20 to-amber-600/10 rounded-2xl flex items-center justify-center relative">
                  <img 
                    src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=500&fit=crop&crop=face" 
                    alt="Davi Ribas"
                    className="w-full h-full object-cover rounded-2xl glow-gold"
                  />
