    ...
    <footer className="py-16 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12">
          ...
          <button className="btn-premium text-lg glow-royal-strong animate-glow-pulse magnetic-element">
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gradient-to-br from-royal-500 to-cosmic-600 rounded-lg flex items-center justify-center glow-royal">
